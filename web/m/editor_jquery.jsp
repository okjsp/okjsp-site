...
<body>
    ...
    <fieldset>
        <div class="row">
            <label>bbs</label>
            <select name="bbs" size="1"  style="width:200px ">
        ...
        <div class="row">
            <label>CCL</label>
            <select name="ccl_id" size="1" style="width:200px ">
        ...
        <div class="row">
            <label>Content</label>
            <textarea name="content" id="content" rows="6" class="write"  style="width:200px "></textarea>
        </div>
    </fieldset>
